...
const missingStudents = [
    ...
    { name: "Snehal Eknath Avhad", email: "Unknown", mobile: "Unknown", course: "Unknown" }
];
...
xlsx.writeFile(wb, "C:/CET EXAM ONLINE/Final_Missing_Students_List.xlsx");

// Generate PDF
const doc = new PDFDocument({ margin: 50 });
doc.pipe(fs.createWriteStream('C:/CET EXAM ONLINE/Final_Missing_Students_List.pdf'));

doc.fontSize(20).text('Final Missing Students from Old PDFs', { align: 'center' });
doc.moveDown(2);
...
doc.end();
console.log("Generated Final_Missing_Students_List files with Snehal added!");
