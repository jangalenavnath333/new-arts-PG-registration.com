...
export const EmailTemplates = {
  ...
  entranceNotification: (name) => ({
    subject: `📢 महत्त्वाची सूचना: एम.एस्सी. प्रवेश परीक्षा (उद्या)`,
    html: wrapEmail(`
      <h2 style="margin: 0 0 16px; color: #dc2626; font-size: 20px; text-align: center;">📢 महत्त्वाची सूचना 📢</h2>
      ...
      <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 20px 0;">
        <p style="margin: 0 0 12px; color: #1e293b; font-size: 14px; line-height: 1.7;">
          एम.एस्सी. कॉम्प्युटर सायन्स आणि कॉम्प्युटर ॲप्लिकेशन्स अभ्यासक्रमाच्या प्रवेश परीक्षेसाठी अर्ज केलेल्या सर्व विद्यार्थ्यांना सूचित करण्यात येते की, <strong style="color: #b91c1c;">उद्या आपली प्रवेश परीक्षा ऑफलाईन पद्धतीने सकाळी ९:३० ते ११:०० या वेळेत होणार असून, सर्व विद्यार्थ्यांनी सकाळी ९:०० वाजता रिपोर्टिंग वेळेनुसार उपस्थित राहणे बंधनकारक आहे.</strong>
        </p>
        <p style="margin: 0 0 12px; color: #1e293b; font-size: 14px; line-height: 1.7;">
          सध्याचे पावसाचे वातावरण लक्षात घेता, <strong>विशेषतः बाहेरगावाहून येणाऱ्या विद्यार्थ्यांनी वेळेवर पोहोचण्यासाठी आपल्या प्रवासाचे आगाऊ व योग्य नियोजन करावे;</strong> या प्रवेश परीक्षेस अनुपस्थित राहिल्यास <strong>आपण प्रवेशासाठी पात्र ठरणार नाही.</strong>
        </p>
        <p style="margin: 0 0 12px; color: #1e293b; font-size: 14px; line-height: 1.7;">
          विद्यार्थ्यांनी आपल्या लॉगिनमधून <strong style="color: #1d4ed8;">हॉल तिकीट (Admit Card) डाऊनलोड करून त्याची प्रिंट उद्या सोबत आणणे अनिवार्य आहे,</strong> त्याशिवाय परीक्षा हॉलमध्ये प्रवेश दिला जाणार नाही.
        </p>
        <p style="margin: 0 0 12px; color: #1e293b; font-size: 14px; line-height: 1.7;">
          परीक्षेचा अभ्यासक्रम आणि प्रश्नपत्रिकेचे स्वरूप यापूर्वीच ग्रुपवर पोस्ट केलेले आहे, ते सर्वांनी पुन्हा एकदा काळजीपूर्वक वाचून वेळेवर उपस्थित राहावे. 
        </p>
        <p style="margin: 0; color: #059669; font-size: 15px; font-weight: bold; text-align: center; padding-top: 10px;">
          परीक्षेसाठी सर्व विद्यार्थ्यांना हार्दिक शुभेच्छा! 💐
        </p>
      </div>

      <div style="margin-top: 30px; text-align: right;">
        <p style="margin: 0 0 4px; color: #1e293b; font-size: 15px; font-weight: bold;">- प्रा. अरुण गांगर्डे</p>
        <p style="margin: 0; color: #475569; font-size: 13px;">प्रमुख, कॅसास (Center For Advanced Studies in Applied Sciences)</p>
